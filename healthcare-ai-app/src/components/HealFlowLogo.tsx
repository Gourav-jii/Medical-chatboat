...
export default function HealFlowLogo({
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 hover:scale-105 bg-white ${
        lightMode 
          ? 'shadow-black/5' 
        ...
        <svg className={iconSize} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            fill="url(#healflow-heart-gradient)"
          />
          {/* EKG pulse line */}
          <path
          ...
          />
          <defs>
            <linearGradient id="healflow-heart-gradient" x1="2" y1="3" x2="22" y2="21" gradientUnits="userSpaceOnUse">
